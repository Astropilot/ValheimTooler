...
namespace ValheimTooler.Configuration
{
	...
	public struct KeyboardShortcut
    {
        ...
        public static KeyboardShortcut Deserialize(string str)
        {
            ...
            {
                ZLog.Log("Failed to read keybind from settings: " + ex.Message);
                return Empty;
            }
        }
        ...
        private bool ModifierKeyTest()
        {
            ...
            if (_modifierBlockKeyCodes == null)
                _modifierBlockKeyCodes = AllKeyCodes.Except(new[] { KeyCode.Mouse0, KeyCode.Mouse1, KeyCode.Mouse2, KeyCode.Mouse3, KeyCode.Mouse4, KeyCode.Mouse5, KeyCode.Mouse6, KeyCode.None }).ToArray();
